...
def create_single_file_dataset(tokenizer: Tokenizer, fname: str, seq_len: int = 1024) -> Dataset:
    ...
    with open(fname) as rf:
        ...
        tensors = [[bos_token] + tokens[i : i + num_toks] + [eos_token] for i in range(0, num_samples, num_toks)]
